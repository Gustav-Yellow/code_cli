...
/**
 * MCP 工具 inputSchema 清洗器。
 *
 * 第三方 MCP server 返回的 inputSchema 可能包含 $schema / $id / $ref / anyOf / oneOf
 * 等 JSON Schema 关键字，部分 LLM 的 function calling API 不接受这些字段。
 * 清洗后保证 type 和 properties 字段存在，description 截断至 1000 字符。
 */

...
/**
 * SerpAPI 搜索 provider（骨架实现）。
 *
 * <p>商业聚合服务，帮我们绕过 Google 反爬。需在环境变量或 .env 中配置 SERPAPI_KEY。
 * 当前为骨架实现——isReady() 始终返回 false，提示用户配置 SERPAPI_KEY。
 * 配置后即可自动启用。
 */
public class SerpApiSearchProvider implements SearchProvider {
    ...
    public String unavailableHint() {
        return "Web 搜索未配置 SerpAPI Key。请在 .env 中设置 SERPAPI_KEY，"
                + "或 SEARCH_PROVIDER=zhipu 切换到智谱搜索（复用 GLM_API_KEY）。"
